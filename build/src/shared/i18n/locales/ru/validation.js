export default {
    ...
    triggeringConditionsRequired: 'Поле "Условие срабатывания" обязательно для заполнения',
    triggeringAlgorithmRequired: 'Поле "Алгоритм срабатывания" обязательно для заполнения'
};
