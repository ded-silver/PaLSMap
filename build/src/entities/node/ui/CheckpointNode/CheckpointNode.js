...
export var CheckpointNode = function (_a) {
    ...
    var handleChangeNodeName = useDebouncedCallback(function () {
        if (node === null || node === void 0 ? void 0 : node.position) {
            updateCurrentNode(__assign(__assign({}, node), { id: id, type: 'Checkpoint', position: node === null || node === void 0 ? void 0 : node.position, data: data }));
        }
    }, 500);
