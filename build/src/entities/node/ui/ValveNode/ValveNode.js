...
export var ValveNode = function (_a) {
    ...
    var handleChangeNodeName = useDebouncedCallback(function (text) {
        if (node === null || node === void 0 ? void 0 : node.position) {
            updateCurrentNode(__assign(__assign({}, node), { id: id, type: 'Valve', position: node === null || node === void 0 ? void 0 : node.position, data: data }));
        }
    }, 500);
