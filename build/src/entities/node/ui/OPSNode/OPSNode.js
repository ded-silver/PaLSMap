...
export var OPSNode = function (_a) {
    ...
    var handleChangeNodeName = useDebouncedCallback(function () {
        if (node === null || node === void 0 ? void 0 : node.position) {
            updateCurrentNode(__assign(__assign({}, node), { id: id, type: 'OPS', position: node === null || node === void 0 ? void 0 : node.position, data: data }));
        }
    }, 500);
    return (_jsxs("div", { className: styles['nodeName'], children: [_jsx("input", { value: nodeName, placeholder: t('placeholders.nodeName', { ns: 'nodes' }), readOnly: isAdmin !== 'true', onChange: function (e) {
                    if (isAdmin === 'true') {
