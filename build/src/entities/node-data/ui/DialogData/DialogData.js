...
export var DialogData = function (_a) {
    var id = _a.id, open = _a.open, handleClose = _a.handleClose, dialogName = _a.dialogName;
                    ...
                    sx: {
                        backgroundColor: '#e6f0ff' // светло-серый фон
                            ...
                            color: '#fff'
                                    ...
                                    right: 8,
                                    top: 8
                                }, children: _jsx(CloseIcon, {}) })] }), _jsx(DialogContent, { children: _jsx(Grid, { container: true, spacing: 2, height: '100%', children: _jsxs(Grid, { item: true, xs: 12, sx: { display: 'flex', flexDirection: 'column' }, children: [_jsx("div", { style: {
                                            display: 'flex',
